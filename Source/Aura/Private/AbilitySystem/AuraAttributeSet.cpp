...
void UAuraAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	//Vital
	DOREPLIFETIME_CONDITION_NOTIFY(UAuraAttributeSet, Health, COND_None, REPNOTIFY_Always);//default is OnChanged, its an optimization. 
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	if(Data.EvaluatedData.Attribute == GetIncomingDamageAttribute())
	{
		...
		{
			float test = GetHealth() - LocalIncomingDamage;
			UE_LOG(LogTemp, Warning, TEXT("Current Health %f. Test: %f"), GetHealth(), test);
