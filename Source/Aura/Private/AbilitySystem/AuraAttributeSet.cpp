...
void UAuraAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	//need for all attributes that get replicated
	//Vital
	DOREPLIFETIME_CONDITION_NOTIFY(UAuraAttributeSet, Health, COND_None, REPNOTIFY_Always);//default is OnChanged, it's an optimization. 
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	{
		FString name = Props.TargetCharacter->GetName();
		bool bAreSame = name == L"BP_Goblin_Spear_C_3";
		if (Props.TargetCharacter->GetName() == L"BP_Goblin_Spear_C_3")
		{
